...
<div id="page" class="hfeed site">
	...
	<div id="main" class="wrapper">
	  ...
	  <div id="filters">
        ...
        $d = get_dimensions($posts);
        $i = get_inaltimes($posts);
        $l = get_latimes($posts);
        
	    ?>
	    
	    
      <select class="option-set" data-filter-group="dimensiune">
        <option selected class="selected" data-filter-value="">Dimensiune jeanta ...</option>
        <option data-filter-value="aha">Aha</option>
      </select>
      
      <select class="option-set" data-filter-group="inaltime">
        <option selected class="selected" data-filter-value="">Inaltime ...</option>
      </select>
      
      <select class="option-set" data-filter-group="latime">
        <option selected class="selected" data-filter-value="">Latime ...</option>
      </select>
	  </div>
	  ...
	  <div id="posts">
        ...
        <article class="<?php echo implode(' ', $klass); ?> thumb">
          ...
          <figure>
            <a href="<?php echo $link ?>" title="<?php echo $title ?>"><?php echo $title; ?>
